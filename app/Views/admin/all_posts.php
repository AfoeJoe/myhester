...
<div class="table-responsive">
  <table class="table table-bordered">
        ...
        <tr>
          ...
          <td>
            ...
            <div class="btn-group" role="group" aria-label="Basic example">
              <a type="button" class="btn btn-secondary" href="<?= base_url('/admin/edit-post/?id='.$post['id']) ?>">Edit</a>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="<?= base_url('/admin/delete-post/?id='.$post['id']) ?>" class="btn btn-primary">Yes</a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <?= $pager->links('group','bootstrap_default') ?>
